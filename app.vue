<template>
  <div class="pa5 pr6">
    ...
    <div class="cf">
      <div class="measure fl">
        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Illum similique ratione ex explicabo soluta ab fuga
        minima, qui nobis omnis doloribus unde magni quod modi quos! Porro necessitatibus eveniet voluptates!
      </div>
    </div>
    ...
    <div id="section-1 cf" class="section">
      ...
      <div class="w-third fl">
        <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Recusandae libero provident dolorem excepturi minus
          quaerat quasi assumenda optio quod eveniet, voluptatum pariatur ducimus facere, consequatur reiciendis ea vero
          aliquam nam.</p>
      </div>
    </div>
    ...
    <div id="section-3" class="section w-100 cf">
      ...
      <div class="w-50 fl">
        TK% of the world's oceans are Coral Reefs
      </div>
    </div>

    <div id="section-4" class="section w-100 cf">
      <h2>Reef type breakdown</h2>
      <div class="h5 ba b--black bw3 w-100 ">

      </div>
      <div class="cf">
        <div class="reef-type w-third fl">
          Resist
        </div>
        <div class="reef-type w-third fl">
          Recover
    ...
    <ReefTypeModule class="ba b--black pa4" :title="'Recover'" />

    <ReefTypeModule class="ba b--black pa4" :title="'Avoid'" />
    ...
    <div id="section-6" class="section w-100">
      ...
      <div id="section-7" class="section">
        ...
        <div class="measure-wide">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Eos saepe ducimus natus accusamus beatae error
          reprehenderit corrupti! Nulla beatae, sed perferendis nisi labore perspiciatis. Suscipit sit maiores placeat
          error libero.
        </div>
        ...
        <div class="w-100 cf">
          <div class="w-third fl">
            <h2 class="f1">Gov</h2>
            <div>arrow</div>
            <div>Lorem ipsum dolor sit amet consectetur adipisicing elit. Vitae sequi iusto at perferendis quaerat
              explicabo ut. Quod ducimus doloremque odio, et maxime officia odit, magnam ea pariatur debitis deserunt
              commodi?</div>
            <button>CTA</button>
          </div>
          <div class="w-third fl">
